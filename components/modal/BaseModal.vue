        ...
        <transition :name="transitionName" appear>
            <div class="modal" :class="modalClassesNormalized" ref="modal">
                ...
                <div v-else class="modal__container" ref="container">
                    <div v-if="$slots.close || isCloseButton" class="modal__close">
                        <base-button icon="cross" mod="_icon modal__close-button" theme="transparent" @click.native.prevent="$modalize.close()" />
                    </div>
